...
import 'package:scribble_clone/models/my_custom_painter.dart';
import 'package:scribble_clone/sidebar/player_scoreboard.dart';
import 'package:scribble_clone/utils/colors.dart';
import 'package:scribble_clone/waiting_lobby.dart';
import 'package:socket_io_client/socket_io_client.dart' as IO;

import 'final_leader_board.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void renderTextBlank(String text) {
    ...
    for (int i = 0; i < text.length; i++) {
      textBlankWidget.add(const Text('_', style: TextStyle(fontSize: 30,color: Colors.white)));
    }
  }
  ...
  void connect() {
    ...
    _socket.onConnect((data) {
      ...
      _socket.on(
          'notCorrectGame',
          (data) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('You cannot join this room !')));
  ...
  Widget build(BuildContext context) {
    ...
    void selectColor() {
      showDialog(
          ...
          builder: (context) => AlertDialog(
                title: const Text('Choose Color',style: TextStyle(fontWeight: FontWeight.bold),),
    ...
    return Scaffold(
      ...
      backgroundColor: stealLight,
      body: Container(
        child: dataOfRoom.isNotEmpty ?
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text(
                                  msg.elementAt(1),
                                  style: TextStyle(
                                      color: bluishWhite, fontSize: 16,fontWeight: FontWeight.bold),
                                ),
                              );
                            }
                        )
